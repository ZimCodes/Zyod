...
public class ODDemoRef {
    public static final String GO_INDEX = "https://ossdev.node6.workers.dev";
    public static final String GD_INDEX = "https://gdindex-demo.maple3142.workers.dev";
