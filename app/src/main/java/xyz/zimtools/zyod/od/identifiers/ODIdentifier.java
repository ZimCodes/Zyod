...
abstract class ODIdentifier implements Identifier {
    protected final RemoteWebDriver driver;

    public ODIdentifier(RemoteWebDriver driver) {
        this.driver = driver;
    }
    ...
    protected boolean findTextCheck(String cssSelect, String matchText, boolean caseSensitivity) {
        Optional<WebElement> element = NavSupport.getIDElement(this.driver, cssSelect);
    ...
    protected boolean exists(String cssSelect) {
        List<WebElement> elements = NavSupport.getIDElements(this.driver, cssSelect);
